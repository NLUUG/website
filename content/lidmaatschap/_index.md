...
Als je werkgever deelneemt aan een Bedrijfsregeling (zie hieronder) dan kan de lidmaatschapsbijdrage voldaan worden uit die regeling. De voorwaarde is wel dat er per type Bedrijfsregeling een maximum is aan het aantal individuele leden.

#### Tarieven

| Type              | Excl. BTW  | Incl. BTW  |
| ---               | ---------: | ---------: |
| Lid (persoon)     | € 165,00   | € 199,65   |
| Student (voltijd) |  € 35,12   |  € 42,50   |
...
ZZP-ers kunnen hun bedrijf aanmelden voor een Bedrijfsregeling D1 (zie de tabel hieronder). Zij betalen dan hetzelfde als wanneer ze rechtstreeks persoonlijk Lid worden en kunnen hun lidmaatschapsbijdrage verrekenen uit de Bedrijfsregeling. Het voordeel is dat de factuur op naam van het bedrijf komt: het bedrijf kan de BTW verrekenen, als privépersoon is dat niet mogelijk.

#### Kostenbesparing
Kleinere organisaties kunnen kiezen voor de Bedrijfsregeling D2 of de Bedrijfsregeling D4. De organisatie betaalt dan *twee*, respectievelijk *vier* keer het eenheidstarief, maar vanuit die bijdrage kunnen maximaal **drie**, respectievelijk **vijf** personen lid worden en / of als introducé deelnemen aan onze conferenties.

Grotere organisaties kunnen kiezen voor de Bedrijfsregeling D8 of de Bedrijfsregeling DP. De organisatie betaalt dan *acht*, respectievelijk *zestien* keer het eenheidstarief, maar vanuit die bijdrage kunnen maximaal **tien**, respectievelijk **twintig** personen lid worden en / of als introducé deelnemen aan onze conferenties.
...
Elke organisatie met een Bedrijfsregeling D2 of hoger mag de beschibare ruimte voor personen verdelen tussen  **leden** ("L" of "S") en **introducés** (I). Leden ("L" èn "S") hebben stemrecht in de Algemene Ledenvergadering (ALV), ze hebben (gratis) toegang tot onze conferenties  en ze kunnen ook worden uitgenodigd voor besloten bijeenkomsten als borrels of tutorials. Introducés hebben gratis toegang tot een conferentie en verder geen rechten. 

Stel, we hebben een organisatie die een D4 Bedrijfsregeling met de NLUUG getroffen heeft. Die organisatie mag vijf personen afvaardigen naar onze conferenties. Dat kan bijvoorbeeld verdeeld worden over drie leden en twee introducés, of vier om één,  of zelfs over vijf introducés -- waarmee die organisatie dan wel alle spreekrecht in de ALV opgeeft.
...
| Code |  max L/S/I | Excl. BTW   |  Incl. BTW  |
| ---  | :--------: | ----------: | ----------: |
| D1   |   1        | € 165,00    | € 199,65    |
| D2   |   3        | € 330,00    | € 399,30    |
| D4   |   5        | € 660,00    | € 798,60    |
| D8   |  10        | € 1.320,00  | € 1.597,20  |
| DP   |  20        | € 2.640,00  | € 3.194,40  |
