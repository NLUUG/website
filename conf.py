...
BLOG_TITLE = "NLUUG"  # (translatable)
# This is the main URL for your site. It will be used
# in a prominent link. Don't forget the protocol (http/https)!
SITE_URL = "https://nluug.nl/"
# This is the URL where Nikola's output will be deployed.
# If not set, defaults to SITE_URL
# BASE_URL = "https://nluug.nl/"
BLOG_EMAIL = "website@nluug.nl"
BLOG_DESCRIPTION = "Laatste nieuws, doelstellingen en ledeninformatie van de vereniging NLUUG."  # (translatable)
...
# MB (2023-03-28): "pages" weggehaald in 2e kolom zodat pagina's in root komen vergelijkbaar met oude website
POSTS = (
    ("events/*.rst", "events", "post.tmpl"),
    ("content/nieuws/*.rst", "nieuws", "post.tmpl"),
    ("posts/*.rst", "", "post.tmpl"),
...
# MB: aangemaakt om te voorkomen dat /index.html aangemaakt wordt in root
INDEX_PATH = "blog"
...
# MB (2023-03-27): vergroot code en voegt weinig toe
...
TWITTER_CARD = {
    ...
    'site': '@nluug',         # twitter nick for the website
    'creator': '@nluug',     # Username for the content creator / author.
}
